        ...
        <article class="message fixed-grid">
            ...
            {#each searchFields as field}
                {#if field.name === 'search'}
                    <div class="search-field field columns pb-3">
                        <label for={field.name} class="label column is-small is-2">{field.label}</label>
                        <div class="control has-icons-right column is-10">
