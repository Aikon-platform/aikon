 ...
 * @property {number} qRegionExtraction: id of the region extraction the query image belongs to
 * @property {number} sRegionExtraction: id of the region extraction the similarity image belongs to
