...
#     "webapp.middleware.error_notification.ServiceUnavailableNotificationMiddleware",
# ]
#
# if DEBUG:
#     INSTALLED_APPS += [
...
# DEFAULT_FROM_EMAIL = ENV.str("DEFAULT_FROM_EMAIL", default=f"noreply@{APP_NAME}.com")
#
# ADMINS = [(f"{APP_NAME} admin", CONTACT_MAIL)]
#
