...
update_env() {
    ordered_params=("APP_NAME" "DB_NAME" "DB_USERNAME" "DB_PASSWORD" "ALLOWED_HOSTS" "SECRET_KEY" "MEDIA_DIR" "DEBUG" "DB_HOST" "DB_PORT" "SAS_USERNAME" "SAS_PASSWORD" "SAS_PORT" "CANTALOUPE_PORT" "CANTALOUPE_PORT_HTTPS" "PROD_URL" "GEONAMES_USER" "APP_LANG" "EXAPI_URL" "EXAPI_KEY" "REDIS_PASSWORD")
    ...
    for param in "${ordered_params[@]}"; do
        ...
        case $param in
            ...
            "HTTPS_PORT")
                ...
                ;;
            "LOG_PATH")
                default_val="$APP_ROOT"/cantaloupe/log
                ;;
            *)
                default_val="$current_val"
                ;;
